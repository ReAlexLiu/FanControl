...
typedef struct _AppsConfigMessage {
    char temperature_sensor1[8];
    char temperature_sensor2[8];
    char temperature_sensor3[8];
    char temperature_sensor4[8];
} AppsConfigMessage;
...
#define AppsConfigMessage_init_default           {"", "", "", ""}
...
#define AppsConfigMessage_init_zero              {"", "", "", ""}
...
#define AppsConfigMessage_temperature_sensor1_tag 1
#define AppsConfigMessage_temperature_sensor2_tag 2
#define AppsConfigMessage_temperature_sensor3_tag 3
#define AppsConfigMessage_temperature_sensor4_tag 4
...
X(a, STATIC,   SINGULAR, STRING,   temperature_sensor1,   1) \
X(a, STATIC,   SINGULAR, STRING,   temperature_sensor2,   2) \
X(a, STATIC,   SINGULAR, STRING,   temperature_sensor3,   3) \
X(a, STATIC,   SINGULAR, STRING,   temperature_sensor4,   4)
...
#define AppsConfigMessage_size                   36
#define CONFIG_PB_H_MAX_SIZE                     ConfigMessage_size
#define ConfigMessage_size                       141
